...
<div class="container">
  <div class="row">
    <div class="col-sm-4">
     ...
     <div class="col-sm-4">
      <h2><center><i>Driver Signup</i></center></h2> 
    </div>
     <div class="col-sm-4">
    </div>
  </div>
...
$row = mysqli_fetch_assoc($res);
    ...
    $password = password_hash($password,PASSWORD_BCRYPT,$options);
            ...
            $result = mysqli_query($conn,"INSERT into users(fname,lname,username,email,insurance_company,insurance_no,user_district,password,date) values('$fname','$lname','$username','$email','$insurance_company','$insurance_no','$user_district','$password','$date')");
...
<div class="form-group">
  ...
  <div class="form-group">
    <label class="label_txt">Insurance company </label>
    <input type="text" class="form-control" name="insurance_company" value="<?php if(isset($error)){ echo $_POST['insurance_company'];}?>" required="">
  </div>
  <div class="form-group">
    <label class="label_txt">Insurance No </label>
    <input type="text" class="form-control" name="insurance_no" value="<?php if(isset($error)){ echo $_POST['insurance_no'];}?>" required="">
  </div>
  <div class="form-group">
    <label class="label_txt">District</label>
    <input type="text" class="form-control" name="user_district" value="<?php if(isset($error)){ echo $_POST['user_district'];}?>" required="">
  </div>
  <div class="form-group">
